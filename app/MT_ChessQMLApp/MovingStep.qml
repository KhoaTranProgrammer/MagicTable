...
Item {
    ...
    function addItem(step, whitemove, blackmove) {
        id_characterList.append({"step": step, "whitemove": whitemove, "blackmove": blackmove})
    ...
    function updateItem(step, whitemove, blackmove) {
